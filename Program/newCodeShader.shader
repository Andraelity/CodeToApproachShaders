Shader "Unlit/ElementoDifernecia"
{
    Properties
    {
...
#define SURF_DIST 1e-3
            ...
            float drawSquareNorm(float2 coordenadas, float2 uv)
            {
                ...
                float extremoInferiorIz = 0.0;
                float extremoInferiorIz2 = 0.0;
                float extremoSuperiorDe = 0.1/1.699121;
                float extremoSuperiorDe2 = 0.1;
            ...
            float drawSquareNumbers0(float2 coordenadas, float2 uv)
            {
            
                float extremoInferiorIz = 0.0;
                float extremoInferiorIz2 = 0.0;
                float extremoSuperiorDe = 0.01/1.330542;
            ...
            {   
                ...
                coordenadaDibujar = float2(0.5,0.5) * (sin(_Time.y*10) > 0 ?    sin(_Time.y*10) :  1);
                ...
                if(drawSquareNumbers0   (coordenadaOrigen,uv) < 1.0){

                    col = fixed4(0.1,0.29,0.49,0.5);
                };
